...
<!--
body {
	background-image: url(/sima/imagenes/imagenesModulos/nefro2.png);
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p1i0","p0i1",[0,"Cargos a Px Externos","","",-1,-1,0,"/sima/OPERACIONESHOSPITALARIAS/nefrologiaDiabetologia/cargosExternos.php","_self","","","","",0,0,0,"","",0,0,0,0,1,"#E6EFF9",1,"#000000",0,"","",3,3,0,0,"#E6EFF9","#000000","#FFFFFF","#6699FF"],165,20);
stm_aix("p1i0","p0i1",[0,"Internar Paciente","","",-1,-1,0,"/sima/OPERACIONESHOSPITALARIAS/nefrologiaDiabetologia/internarPaciente.php","_self","","","","",0,0,0,"","",0,0,0,0,1,"#E6EFF9",1,"#000000",0,"","",3,3,0,0,"#E6EFF9","#000000","#FFFFFF","#6699FF"],165,20);
stm_aix("p1i0","p0i1",[0,"Cargos a Px Internos","","",-1,-1,0,"/sima/OPERACIONESHOSPITALARIAS/nefrologiaDiabetologia/cargosInternos.php","_self","","","","",0,0,0,"","",0,0,0,0,1,"#E6EFF9",1,"#000000",0,"","",3,3,0,0,"#E6EFF9","#000000","#FFFFFF","#6699FF"],165,20);
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p1i0","p0i1",[0,"Reposision por Venta","","",-1,-1,0,"salidaInventarios.php","_self","","","","",0,0,0,"","",0,0,0,0,1,"#E6EFF9",1,"#000000",0,"","",3,3,0,0,"#E6EFF9","#000000","#FFFFFF","#6699FF"],165,20);
<?php } ?>
