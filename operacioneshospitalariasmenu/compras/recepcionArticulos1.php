...
<form id="form1" name="form1" method="GET" action="recepcionArticulos1.php">
  <table width="382" border="0" align="center" bgcolor="#FFFFFF" class="style7">
    ...
    <tr>
      ...
      <td bgcolor="#FFCCFF"><input name="importeFactura" type="text" class="style7" id="importeFactura" value="<?php echo $myrow3['importeFactura'];?>" size="10" /></td>
    </tr>
    <tr>
  ...
  <table width="821" border="0" align="center">
    ...
    <tr>
      <th width="37" bgcolor="#660066" scope="col"><span class="style11">C&oacute;digo</span></th>
      <th width="331" bgcolor="#660066" scope="col"><span class="style11">Descripci&oacute;n</span></th>
      <th width="36" bgcolor="#660066" scope="col"><span class="style11">UM</span></th>
      <th width="40" bgcolor="#660066" scope="col"><span class="style11">C.Sol. </span></th>
      <th width="50" bgcolor="#FFFFFF" scope="col"><span class="style17"></span></th>
      <th width="25" bgcolor="#660066" scope="col"><span class="style11">C.Fac</span></th>
      <th width="25" bgcolor="#660066" scope="col"><span class="style11">C.Rec</span></th>
      <th width="31" bgcolor="#660066" scope="col"><span class="style11"> Faltan </span></th>
      <th width="40" bgcolor="#660066" scope="col"><span class="style11">Iva</span></th>
      <th width="38" bgcolor="#660066" scope="col"><span class="style11">Costo</span></th>
      <th width="46" bgcolor="#660066" scope="col"><span class="style11">T. Fact</span></th>
      <th width="47" bgcolor="#660066" scope="col"><span class="style11">NC </span></th>
      <th width="21" bgcolor="#660066" scope="col"><span class="style11">Obs.</span></th>
    </tr>
    <tr>
<?php	
