...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="683" border="0" align="center">
    <tr>
      ...
      <th width="413" bgcolor="#660066" scope="col"><div align="center">
      ...
      <th width="138" bgcolor="#660066" scope="col"> <div align="left" class="blanco">
        <div align="left">Proveedor (Agregar) </div>
      </div></th>
    </tr>
    <?php	
$sSQL= "SELECT  
...
?>
    <tr>
	  ...
	  <a href="javascript:ventanaSecundaria('listadoProveedores.php?keyR=<?php echo $myrow['keyR']; ?>&id_requisicion=<?php echo $_GET['id_requisicion']; ?>&usuario=<?php echo $usuario; ?>&almacen=<?php echo $ali; ?>')">
