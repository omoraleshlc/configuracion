...
document.Form2.criterio.focus();
  ...
  <table width="863" border="2" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFF00" bgcolor="#0000FF">
    <tr>

      <th width="451" bgcolor="#660066" scope="col"><div align="left" class="blanco">
        <div align="left">Descripci&oacute;n</div>
      </div></th>
      <th width="226" bgcolor="#660066" scope="col"><div align="left" class="blanco">
        <div align="left">GRUPO</div>
      </div>      </th>
      <th width="73" bgcolor="#660066" scope="col">Agregar Almacenes</th>
      <th width="88" bgcolor="#660066" scope="col"><div align="left" class="blanco">
        <div align="center">Ajustar Precio</div>
      </div></th>
    </tr>
...
echo mysql_error();
      ...
      <td bgcolor="<?php echo $color;?>" class="style71" ><div align="center"><span class=""> <a  href="javascript:ventanaSecundaria2('/sima/cargos/listaAlmacenes.php?codigo=<?php echo $code; ?>&seguro=<?php echo $_GET['seguro']; ?>&medico=<?php echo $_GET['medico']; ?>&usuario=<?php echo $usuario; ?>&keyPA=<?php echo $myrow['keyPA']; ?>')"> 
      <img src="/sima/imagenes/btns/precio.png" alt="Almacenes" width="20" height="20" border="0" /></a> </span></div></td>
    </tr>
    <?php }?>
  </table>
  <p align="center">
