...
<?php
$sSQL2a1= "Select * From modulosGrupos WHERE  clasificacion='GEN'  ";
$result2a1=mysql_db_query($basedatos,$sSQL2a1);
$myrow2a1 = mysql_fetch_array($result2a1);
if($myrow2a1['clasificacion']=='GEN'){
...
function ventanaSecundaria3 (URL){ 
   window.open(URL,"ventana3","width=800,height=600,scrollbars=YES") 
} 
</script>
...
codigo,descripcion,descripcion1,um,gpoProducto,usuario,fecha,cbarra,laboratorio,sustancia,activo,umVentas,ventaPieza,observaciones,
cajaCon,hora,entidad,generico,servicio,paquete,random,
caducidad,antibiotico,grupo) 
...
'".$_GET['caducidad']."','".$_GET['antibiotico']."' ,'".$_GET['grupo']."' )";
...
<body>
<h1 align="center" >Alta/Modifica Medicamentos Gen&eacute;ricos</h1>
...
<tr>
  ...
  <table width="535" class="table-forma">
    ...
    <tr>
      ...
      <td width="377" ><label>
          <div align="left">
            ...
            <textarea name="descripcion" cols="45" rows="3" wrap="virtual"  id="descripcion"><?php echo $myrow['descripcion'];?></textarea>
            <input name="generico" type="hidden" id="generico" value="si" />
          </div>
        </label></td>
    </tr>
    <tr>
      <td  scope="col">&nbsp;</td>
      <td ><div align="left" ><span >Descripci&oacute;n de impresi&oacute;n</span></div></td>
      <td ><textarea name="descripcion1" cols="45" rows="3" wrap="virtual"  id="descripcion1"><?php echo $myrow['descripcion1'];?></textarea></td>
    </tr>
    <tr>
      <td width="7"  scope="col">&nbsp;</td>
    ...
    <tr>
      <td  scope="col">&nbsp;</td>
      <td >Antibiotico?</td>
      <td ><input type="checkbox" name="antibiotico" value="si" <?php if($myrow['antibiotico']=='si'){echo 'checked="checked"';} ?> /></td>
    </tr>
...
$result71=mysql_db_query($basedatos,$sSQL71); 
 ...
 <td ><label></label></td>
    ...
    <tr>
      <td  scope="col">&nbsp;</td>
      <td ><span >Laboratorio Fabricante:</span></td>
      <td ><label>
        <?php //*********Unidades de Medida
...
$result71=mysql_db_query($basedatos,$sSQL71); 
	  ...
	  ?>
		...
		'catLab.php?descripcion=<?php echo $descripcion; ?>&amp;forma=<?php echo "form1"; ?>&amp;campo=<?php echo "cbarra"; ?>')">Nuevo Laboratorio</a><a href="javascript:ventanaSecundaria('laboratorioF.php?codigo=<?php echo $_GET['codigo']; ?>&amp;seguro=<?php echo $_GET['seguro']; ?>&amp;medico=<?php echo $_GET['medico']; ?>&amp;usuario=<?php echo $usuario; ?>')"></a></td>
    </tr>
    <tr>
      <td  scope="col">&nbsp;</td>
      <td ><span >Sustancia Activa:</span></td>
      <td ><textarea name="sustancia" cols="45" rows="3"  id="sustancia"><?php echo $myrow['sustancia']; ?></textarea></td>
    </tr>
    <tr>
      <td width="7"  scope="col">&nbsp;</td>
