...
//************************EFECTIVOS******************
$sSQL7="SELECT sum(cantidadParticular) as efectivos,sum(cantidadParticular*porcentaje) as ivar
...
$sSQL7d="SELECT  sum(cantidadParticular) as efectivos,sum(cantidadParticular*porcentaje) as ivar
