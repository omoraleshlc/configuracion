...
<?php
$sSQL2a1= "Select * From modulosGrupos WHERE  clasificacion='MEDC'  ";
$result2a1=mysql_db_query($basedatos,$sSQL2a1);
$myrow2a1 = mysql_fetch_array($result2a1);
if($myrow2a1['clasificacion']=='MEDC'){
...
codigo,descripcion,descripcion1,um,gpoProducto,usuario,fecha,cbarra,laboratorio,sustancia,
activo,umVentas,ventaPieza,observaciones,cajaCon,hora,entidad,generico,servicio,paquete,random,
...
<table width="659" class="table-forma">
        <tr >
      <td width="1"  scope="col">&nbsp;</td>
<td colspan="3"  ><div align="center"><span ></span> <br />
    ...
    <tr>
      <th colspan="4"  scope="col"><p align="center" >Medicamentos Controlados</p></th>
    </tr>
    <tr>
      <td width="1"  scope="col">&nbsp;</td>
    <td width="155" >
    ...
    <tr>
      ...
      <td width="377" ><textarea name="descripcion1" cols="60" rows="3"  id="descripcion1"><?php echo $myrow['descripcion1'];?></textarea></td>
      <td width="83" >&nbsp;</td>
    </tr>
...
<td colspan="2" valign="middle"  ><label>
              ...
              <select name="grupo" class="normal">
...
$result71=mysql_db_query($basedatos,$sSQL71); 
 ...
 <td ><label></label></td>
    ...
    <tr>
      <td  scope="col">&nbsp;</td>
      <td >Antibiotico?</td>
      <td colspan="2" ><input type="checkbox" name="antibiotico" value="si" <?php if($myrow['antibiotico']=='si'){echo 'checked="checked"';} ?> /></td>
    </tr>
    <tr>
      <td  scope="col">&nbsp;</td>
      <?php 
...
$result71=mysql_db_query($basedatos,$sSQL71); 
	  ...
	  ?>
        ...
        <a href="laboratorioF.php"></a><a href="javascript:ventanaSecundaria('laboratorioF.php?codigo=<?php echo $_GET['codigo']; ?>&amp;seguro=<?php echo $_GET['seguro']; ?>&amp;medico=<?php echo $_GET['medico']; ?>&amp;usuario=<?php echo $usuario; ?>')"></a></td>
    </tr>
    <tr>
      <td scope="col">&nbsp;</td>
...
<div align="center">
  <p>&nbsp;</p>
  <p><a href="precios.php">Regresar al listado de art&iacute;culos</a></p>
</div>
