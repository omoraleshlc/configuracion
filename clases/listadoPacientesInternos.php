...
<form id="form1" name="form1" method="post" action="#">
  ...
  <table width="519" border="0.2" align="center">
    <tr>
      ...
      <th width="76" bgcolor="#660066" class="style12" scope="col"><div align="left" class="blancomid">Cargos</div></th>
    </tr>
    <tr>
      <?php	
...
?></span></td>
      <td width="76" bgcolor="<?php echo $color?>" class="normalmid">
        <div align="center">
          <?php 

//se agregaron
if(( $almacenesCierreCuenta->almacenesCierreCuenta($bali,$fecha1,$hora1,$usuario,$myrow['keyClientesInternos'],$entidad,$numeroE,$nCuenta,$basedatos)!='cargado' and !$almacenesCierreCuenta->almacenesCierreCuenta($bali,$fecha1,$hora1,$usuario,$myrow['keyClientesInternos'],$entidad,$numeroE,$nCuenta,$basedatos) 
AND 
!$almacenesCierreCuenta->almacenesCierreCuenta($bali,$fecha1,$hora1,$usuario,$myrow['keyClientesInternos'],$entidad,$numeroE,$nCuenta,$basedatos))
