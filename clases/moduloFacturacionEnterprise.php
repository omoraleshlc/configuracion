...
?>
      ...
      <td bgcolor="<?php echo $color;?>" class="<?php echo $estilo;?>"><span class="style71">
...
(numeroE='".$numeroE."' and nCuenta='".$nCuenta."')
 ...
 $porcentaje=$cantidadTransaccion[0]/$myrow74[0];
	...
	?>
<label>
      <input name="facturar" type="submit" class="style7" value="Facturar" <?php if($_GET['facturar'] or $myrow31['statusFactura']=='cargado'){
	  echo 'disabled=""';
	  }
	  ?> />
    </label>
...
&nCuenta=<?php echo $nCuenta; ?>&entidad=<?php echo $entidad; ?>&nT=<?php echo $nT; ?>&numFactura=<?php echo $_GET['numFactura'];?>&porcentaje=<?php echo $porcentaje;?>')">
	Imprimir Factura 
	</a>
...
?>
    ...
    <table width="384" height="0" border="0" align="left" cellpadding="0" cellspacing="1" class="style71">
      <tr>
        ...
        <td bgcolor="#660066" class="style14"><?php echo "$".number_format($sumarIVA[0],2); ?> &nbsp;</td>
 ...
 and (status!='standby' and statusCargo!='standby'  AND status!='cancelado')
  ...
  $sumaIVA=$myrow74['sumaIVA']*$_GET['porcentaje'];
      ...
      <tr>
        ...
        <td width="17%" bgcolor="#660066" class="style14"><?php echo "$".number_format( $acumulado[0]+$sumarIVA[0],2); ?></td>
        <td width="16%" bgcolor="#660066" class="style14"><?php echo "$".number_format($importeP[0]+$sumaIVA,2);?></td>
      </tr>
      <tr>
...
$otros= new acumulados();
  if($cargosParticulares->cargosParticulares($basedatos,$usuario,$numeroE,$nCuenta)==NULL 
  AND 
