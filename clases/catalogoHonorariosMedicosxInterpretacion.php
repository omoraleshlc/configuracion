...
<?php
$sSQL2a1= "Select * From modulosGrupos WHERE  clasificacion='sIVA'  ";
$result2a1=mysql_db_query($basedatos,$sSQL2a1);
$myrow2a1 = mysql_fetch_array($result2a1);
if($myrow2a1['clasificacion']=='sIVA'){
...
codigo,descripcion,descripcion1,um,gpoProducto,usuario,fecha,cbarra,laboratorio,sustancia,activo,umVentas,ventaPieza,observaciones,cajaCon,hora,entidad,generico,servicio,paquete,random,especialidad,laboratorioReferido,referido) 
...
'".$_GET['generico']."','no','".$_GET['paquete']."','".$_GET['random']."','".$_GET['especialidad']."','".$_GET['referido']."','".$_GET['referido']."')";
...
<body>
<h1 align="center">Hon. M&eacute;d. x Interpretaci&oacute;n de Resultados 
</h1>
<form id="form1" name="form1" method="GET" action=""/>

  <table width="607" class="table-forma">
...
<textarea name="descripcion" cols="57" rows="3"  id="descripcion"><?php echo $descripcion = $myrow['descripcion']?></textarea>
	...
	<tr>
	  ...
	  <td ><input name="referido" type="checkbox" id="referido" value="si"
