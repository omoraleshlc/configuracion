...
$sSQL= "Select gpoProducto From reportesFinancieros where 
random='".$random."'
and
gpoProducto!=''
and
...
?>
  ...
  <table width="514" border="0" align="center">
     <tr>
       ...
       <th width="251" bgcolor="#660066" scope="col"><div align="left"><span class="blanco">Descripci&oacute;n de Productos </span>s</div></th>
...
//************************cantidadAseguradora******************
$sSQL7="SELECT sum(cantidadAseguradora) as efectivos,sum(cantidadAseguradora*porcentaje) as ivar
...
$sSQL7d="SELECT  sum(cantidadAseguradora) as efectivos,sum(cantidadAseguradora*porcentaje) as ivar
