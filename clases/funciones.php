...
//DEPRECATED solo afecta al surtir
 $q1ab = "INSERT INTO kardex 
(kc,evento,descripcion,descripcionevento,naturaleza,usuario,fecha,hora,entidad,
keyPA,almacenSolicitante,almacenDestino,costo,cantidad,cantidadtotal,
descripcionArticulo,existencia,existenciaTotal,otro,gpoProducto,tipoMovimiento,
...
$q1a = "UPDATE articulosExistenciasGranel set 
status='sold',keyCAP='".$keyCAP."'
...
('".$codigo."','".$myrow29['keyPA']."','".$gpoProducto."','1','".$myrow['tipoVenta']."','".$entidad."','salida',
    '".$fecha1."','".$hora1."','".$usuario."','".$almacen."','".$keyClientesInternos."','".$folioVenta."','".$myrow3ac['costo']."','".$myrowy['keyAE']."','".$myrowy['tipo']."',
'".$myrowy['factura']."','sold'	)";
//mysql_db_query($basedatos,$agrega);
echo mysql_error();
...
$sSQL7c= "Select sum((cantidadAseguradora*cantidad)+(ivaAseguradora*cantidad)) as cargos  from cargosCuentaPaciente where entidad='".$entidad."'  and folioVenta='".$myrow['folioVenta']."' and naturaleza='A'  and gpoProducto=''  ";
