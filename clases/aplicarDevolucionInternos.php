...
?>	
      ...
      <td bgcolor="<?php echo $color;?>" class="<?php echo $style;?>"><?php echo $myrow81['keyCAP'];?></td>
...
<td class="<?php echo $style;?>"><div align="center"><?php print $myrow81['cantidad']; ?></div></td>
      ...
      <td class="precionormal2" >
        <div align="right">
          <label>
		  <?php if($myrow81['statusDevolucion']!='si'){ ?>
          <input name="keyCAP[]" type="checkbox" id="keyCAP[]" value="<?php echo $myrow81['keyCAP'];?>" />
		  <?php }else{ ?>
		            <input name="keyCAP[]" type="checkbox" id="keyCAP[]" value="<?php echo $myrow81['keyCAP'];?>" disabled="disabled" />
					<?php } ?>
          </label>
        </div></td>
      </tr>
