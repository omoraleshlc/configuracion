...
echo $cierreCuentaReporte->cierreCuentaReportes($entidad,$nT,$numeroE,$nCuenta,$basedatos);
      ...
      <td width="178" bgcolor="<?php echo $color?>" class="normal">
	  <?php echo $seguro;?></span></span></td>
      <td width="60" bgcolor="<?php echo $color?>" class="normal">
	  <?php echo $myrow11['usuario'];
?></td>
      <td width="60" bgcolor="<?php echo $color?>" class="normal" align="center">
	  <?php echo $myrow11['fecha']." ".$myrow11['hora'];
?></td>
      <td width="60" bgcolor="<?php echo $color?>" class="normal" align="center"><?php echo $myrow['cuarto']
?></td>
      <td width="48" bgcolor="<?php echo $color?>" class="normal" align="center">
