...
<!--
body {
	background-image: url(/sima/imagenes/imagenesModulos/inventario2.png);
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p1i0","p0i1",[0,"Medicos","","",-1,-1,0,"catalogoAlmacen.php","_self","","","","",0,0,0,"","",0,0,0,0,1,"#E6EFF9",1,"#000000",0,"","",3,3,0,0,"#E6EFF9","#000000","#FFFFFF","#6699FF"],165,20);
<?php } ?>
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p1i0","p0i1",[0,"Honorarios Medicos","","",-1,-1,0,"honorariosMedicos.php","_self","","","","",0,0,0,"","",0,0,0,0,1,"#E6EFF9",1,"#000000",0,"","",3,3,0,0,"#E6EFF9","#000000","#FFFFFF","#6699FF"],165,20);
<?php } ?>
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p1i0","p0i1",[0,"Interp. Hon. Medicos","","",-1,-1,0,"interpHonMedicos.php","_self","","","","",0,0,0,"","",0,0,0,0,1,"#E6EFF9",1,"#000000",0,"","",3,3,0,0,"#E6EFF9","#000000","#FFFFFF","#6699FF"],165,20);
<?php } ?>


<?php 
$codModulo='SERVICIOS';
$codSM='CatServHospSer';
$checaModuloScript= "Select usuario From usuariosSubmodulos WHERE codModulo='".$codModulo."' 
and codSM = '".$codSM."' and 
usuario1 = '".$usuario."'";
$resScript=mysql_db_query($basedatos,$checaModuloScript);
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p1i0","p0i1",[0,"Servicios Hospitalarios","","",-1,-1,0,"serviciosHospitalarios.php","_self","","","","",0,0,0,"","",0,0,0,0,1,"#E6EFF9",1,"#000000",0,"","",3,3,0,0,"#E6EFF9","#000000","#FFFFFF","#6699FF"],165,20);
<?php } ?>
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p1i0","p0i1",[0,"Lista Servicios","","",-1,-1,0,"precios.php","_self","","","","",0,0,0,"","",0,0,0,0,1,"#E6EFF9",1,"#000000",0,"","",3,3,0,0,"#E6EFF9","#000000","#FFFFFF","#6699FF"],165,20);
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p1i0","p0i1",[0,"Lista Grupo de Productos","","",-1,-1,0,"listadoxGPO.php","_self","","","","",0,0,0,"","",0,0,0,0,1,"#E6EFF9",1,"#000000",0,"","",3,3,0,0,"#E6EFF9","#000000","#FFFFFF","#6699FF"],165,20);
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p1i0","p0i1",[0,"Precios de Medicos","","",-1,-1,0,"medicosPrecios.php","_self","","","","",0,0,0,"","",0,0,0,0,1,"#E6EFF9",1,"#000000",0,"","",3,3,0,0,"#E6EFF9","#000000","#FFFFFF","#6699FF"],165,20);
<?php } ?>
...
stm_aix("p1i0","p0i1",[0,"Menu Admon Hospitalarias","","",-1,-1,0,"/sima/ADMINHOSPITALARIAS/","_self","","","","",0,0,0,"","",0,0,0,0,1,"#E6EFF9",1,"#000000",0,"","",3,3,0,0,"#E6EFF9","#000000","#FFFFFF","#6699FF"],165,20);
