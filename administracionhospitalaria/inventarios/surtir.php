...
$sSQL52="SELECT cantidadTotal,cantidadTotal,totalUnidades
FROM
existencias
WHERE
entidad='".$entidad."'
...
//**************************************************************************************************
$cantidadEnStock=$myrow52['cantidadTotal'];
//**************************************************
...
<form id="form1" name="form1" method="post" action="#">
  ...
  <table width="600" border="0.2" align="center" cellpadding="4" cellspacing="0">
      ...
      <th width="38" class="negromid">Mov</th>
...
nOrden='".$_GET['nOrden']."'
    ...
    status='request'
    and
   (tipoVenta='Normal' or tipoVenta='Suelto')
...
$sSQL2a= "SELECT sum(cantidadAcumulada) as s
FROM
...
echo   $myrow52aa['cantidadTotal'];
      ...
      <td width="54" bgcolor="<?php echo $color?>" class="normal"><?php
...
echo $myrow2['s'];
	...
	<?php echo $total;?>
	 ...
	 <label>
	 <input name="cantidadSurtida[]" type="text" id="cantidadSurtida[]" size="5" maxlength="5" autocomplete="off"
