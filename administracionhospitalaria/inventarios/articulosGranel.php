...
?>
 ...
 <a href="#"  onclick="javascript:ventanaSecundaria('surtirGranel.php?keyPA=<?php echo $myrow['keyPA'];?>&solicitud=<?php echo $myrow['keySAL'];?>&almacenSolicitante=<?php echo $_POST['almacenDestino'];?>&usuario=<?php echo $myrow['usuario'];?>')">
        <?php
