...
<div>
 ...
 <strong>
        ...
        <td width="112">
        	<a href="javascript:ventanaSecundaria1('/sima/cargos/busquedaAvanzada.php?campoDespliega=<?php echo "descripcionPaquete"; ?>&amp;forma=<?php echo "form1"; ?>&amp;campoSeguro=<?php echo "numeroEx"; ?>&amp;seguro=<?php echo "paciente"; ?>')" class="none">
		<div >
		Busqueda Avanzada 
		</div>
		</a>
...
<?php
 $sSQL7a= "Select numMatricula from pacientes where entidad='".$entidad."'  and  numCliente='".$myrow4['numeroE']."'     ";
$result7a=mysql_db_query($basedatos,$sSQL7a);
$myrow7a = mysql_fetch_array($result7a);

?>
        <input name="credencial" type="text"  id="credencial" 
	value="<?php 
	if($myrow7a['numMatricula']){
	echo $myrow7a['numMatricula']; 
	}elseif($_POST['credencial'] ){
	echo $_POST['credencial'];
	} 
	?>" size="20" /></td>
        <td>&nbsp;</td>
