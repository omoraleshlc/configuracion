<?php class detectaNavegador{
public function detectarNavegador(){
$mobile_browser = '0';
 
//$_SERVER['HTTP_USER_AGENT'] -> el agente de usuario que est accediendo a la pgina.
//preg_match -> Realizar una comparacin de expresin regular
...
if($mobile_browser>0){
        // Mostrar contenido para dispositivos mviles
        // Estos pueden ser ms ligeros: un titulo, resumen y algunos enlaces.
    ...
    return 'movil';
		...
		//$url='http://sima.um.edu.mx/sima/MenuIndex.php/';
